                ...
                {MEAL_BLOCK_TYPES.map((type) => (
                    <div key={type.id} className="relative group">
                        ...
                        <button
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2 bg-white dark:bg-slate-800 p-1.5 rounded-full text-emerald-600 dark:text-emerald-400 shadow-sm border border-slate-100 dark:border-slate-700 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 hover:scale-110 transition-all z-50 pointer-events-auto cursor-pointer"
